...
const DEVELOPER_TASKS: DeveloperTaskSeed[] = [
  ...
  },
  {
    ...
    orms: ['Sequelize', 'Custom ORM'],
    docIds: [DOC_IDS.gettingStarted],
    exampleIds: [EXAMPLE_IDS.schemaInspection],
    recipeIds: [RECIPE_IDS.inspectGeneratedSchemaArtifacts],
    pluginIds: [PLUGIN_IDS.sequelize, PLUGIN_IDS.customPlugin],
  ...
  },
  {
    ...
    orms: ['Sequelize', 'Custom ORM'],
    docIds: [DOC_IDS.gettingStarted, DOC_IDS.schemaDesign],
    exampleIds: [EXAMPLE_IDS.generatedQuery],
    recipeIds: [RECIPE_IDS.generatedQueryFields],
    pluginIds: [PLUGIN_IDS.sequelize, PLUGIN_IDS.customPlugin],
  ...
  },
  {
    ...
    orms: ['Sequelize'],
    docIds: [DOC_IDS.schemaDesign],
    exampleIds: [EXAMPLE_IDS.generatedQuery, EXAMPLE_IDS.queryLookahead],
    recipeIds: [RECIPE_IDS.generatedFiltersOrderPagination, RECIPE_IDS.queryLookaheadShape],
    pluginIds: [PLUGIN_IDS.sequelize],
  ...
  },
  {
    ...
    orms: ['Sequelize', 'Custom ORM'],
    docIds: [DOC_IDS.gettingStarted, DOC_IDS.schemaDesign],
    exampleIds: [EXAMPLE_IDS.customMutation],
    recipeIds: [RECIPE_IDS.customQueryOrMutation],
    pluginIds: [PLUGIN_IDS.sequelize, PLUGIN_IDS.customPlugin],
  ...
  },
  {
    ...
    docIds: [DOC_IDS.schemaDesign],
    exampleIds: [EXAMPLE_IDS.customMutation],
    recipeIds: [RECIPE_IDS.cacheFriendlyMutationPayloads, RECIPE_IDS.customQueryOrMutation],
    pluginIds: [PLUGIN_IDS.sequelize, PLUGIN_IDS.customPlugin],
  ...
  },
  {
    ...
    exampleIds: [EXAMPLE_IDS.customPlugin],
    recipeIds: [RECIPE_IDS.customPluginEvaluation, RECIPE_IDS.writeMinimalCustomPlugin],
